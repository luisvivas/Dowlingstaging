...
describe "request_for_quotes/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit request_for_quote form" do
    render

    response.should have_selector("form", :action => request_for_quote_path(@request_for_quote), :method => "post") do |form|

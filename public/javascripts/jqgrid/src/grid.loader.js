...
{
    var pathtojsfiles = "/javascripts/jqgrid/src/"; // need to be ajusted
    ...
    var modules = [
		...
		{ include: true, incfile:'jqDnR.js'}, //Drag and resize
		{ include: true, incfile:'jqModal.js'}, //xmljson utils
		{ include: true, incfile:'ui.multiselect.js'}, //xmljson utils
